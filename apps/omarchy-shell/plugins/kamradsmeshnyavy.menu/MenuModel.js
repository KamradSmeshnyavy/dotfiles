...
// Guard batches answer the same thing on nearly every open. Comparing them is
// far cheaper than rebuilding the display model for no visible change.
function sameGuardResults(a, b) {
  if (a === b) return true
  if (!a || !b) return false
