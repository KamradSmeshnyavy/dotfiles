...
c.content.blocking.method = 'both'  # использует и хосты, и Adblock-фильтры
...
# c.content.user_stylesheets = '~/.qutebrowser/user.css'
#
# # Отключаем тёмный режим для конкретных доменов
# for domain in [
#     'kvk.pub',
#     # добавьте сюда все свои исключения из файла Dark-Reader-Settings.json
# ]:
#     config.set('colors.webpage.darkmode.enabled', False, f'*.{domain}')
