local M = {
	{
		...
		opts = {
			colorscheme = function()
				...
				set_hl("Statement", { fg = colors.secondary, bold = true })
				set_hl("Conditional", { fg = colors.secondary })
				set_hl("Repeat", { fg = colors.secondary })
				set_hl("Keyword", { fg = colors.secondary, bold = true })
				...
				set_hl("Structure", { fg = colors.primary })
				set_hl("Typedef", { fg = colors.primary })

				set_hl("PreProc", { fg = colors.primary })
				set_hl("Include", { fg = colors.secondary })
				set_hl("Define", { fg = colors.secondary })
				...
				vim.g.colors_name = "cyber-pastel-cyan"
			end,
		},
	},
}
