...
alias q = exit 0
alias r = rmpc
alias s = somo # A human-friendly alternative to netstat for socket and port monitoring on Linux and macOS.
alias t = tokei # program that displays statistics about your code
alias u = uv # An extremely fast Python package manager.
